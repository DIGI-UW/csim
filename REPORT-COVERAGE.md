...
| Labels do not follow Month/Quarter/Year | Opt-in renderer patch displays Jan 2025, Q1 2025 and 2025 while retaining real dates. Main also reads the native dashboard grain override. Axis and hover behavior are tested across all five trends. | This is a versioned CSiM customization; it is not a claim that stock 6.1.0 provides these exact labels automatically. |
