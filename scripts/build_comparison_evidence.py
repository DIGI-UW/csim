...
content.append('<section><h2>Every date chart at three screen widths</h2><p>Eleven charts, three groupings and three widths: all 99 x-axis captures retain chronological, complete labels.</p><ul>'+''.join('<li>'+html.escape(finding)+'</li>' for finding in review['findings'])+'</ul>')
