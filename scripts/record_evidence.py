...
p.add_argument('--runtime-revision',help='Deployed application/definition revision, separately from test revision')
...
provenance.update(dashboardSlug=slug,runtimeRevision=a.runtime_revision,runtimeImageId=a.runtime_image_id)
