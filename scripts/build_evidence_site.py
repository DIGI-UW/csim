...
release={'revision':revision,'date':dt.datetime.now(dt.timezone.utc).date().isoformat(),
    'main':'Superset 6.1.0 + versioned CSiM formatter and vertical-filter clear fix','snapshot':'e22ce197866ded732e4990063ae74697d89d383a + CSiM formatter, inclusive month controls and vertical-filter clear fix',
